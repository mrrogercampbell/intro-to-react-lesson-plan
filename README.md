...
- By the end of this lesson students should be able to:
	...
	- Be able to define all words in the `Vocabulary` section below
...
### Thinking in React
This section introduces students to the JavaScript library React and how to conceptualize utilizing it while designing and building applications. Key point to touch on here is encapsulation.
...
- Talk about the complication you encounter when using DOM manipulation in vanilla JavaScript when dealing with enterprise size application
...
Walk students through writing out their first functional component. **Provide a prompt**

#### Class Components
Something here

##### Your Second Component - We Do
Walk students through writing out their first class component. **Provide a prompt**

#### Class vs Functional
Brief explanation of when to use which and the pain points associated with each.

##### Build Two Component - You Do
Have students create a functional and class component on their own. **Provide a prompt**
...
Have student turn to their neighbor and discuss the follow amongst themselves for 10 mins:
  - How they conceptualize props and state
  - What is the difference between prompts and state
**Provide a few more here**
Once 10 mins has lapsed have call on one group for each prompt and have them explain what they discussed in regards to it.

## Check for Understanding
This section is meant to to provide multiple assessment that instructors can utilize to test and quantify student understand of the lesson.
...
- You Do - Test for understanding
	...
	- They are able to ask for instructor assistance
- Cold Call - Student calls on random student(s) to answer prompt(s)
...
Survey Questions:
1. Are learning objectives present and complete?
